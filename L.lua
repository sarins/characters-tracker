...
L["CURR_WEEKLY_LIMIT"] = " (%s/%s)|cff0070dd Weekly|r"
L["CURR_SEASON_LIMIT"] = " (%s/%s)|cFFE6CC80 Season|r"
L["CURR_LIMIT"] = " (%s/%s)"
...
if currentLocale == "zhCN" then
  ...
  L["CURR_WEEKLY_LIMIT"] = " (%s/%s)|cff0070dd 每周|r"
  L["CURR_SEASON_LIMIT"] = " (%s/%s)|cFFE6CC80 赛季|r"
  L["CURR_LIMIT"] = " (%s/%s)"
  L["INV_TITLE"] = "战团物品汇总"
  L["INV_LOADING"] = "加载中..."
  L["INV_SEARCH_TIP"] = "搜索..."
