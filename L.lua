...
-- ====================================================================
if currentLocale == "zhCN" then
  L["FB_FUNC"] = "Отслеживание персонажей отряда"
  L["FB_L1"] = "ЛКМ: открыть/закрыть список персонажей отряда"
  L["FB_L2"] = "Зажать ЛКМ: перетащить кнопку"
  L["VT_TITLE"] = "Еженедельный прогресс Великого хранилища"
  L["VT_RAIDS"] = "Рейды"
  L["VT_DUNGEONS"] = "Подземелья"
  L["VT_DW"] = "Вылазки / открытый мир"
  L["VT_UNLOCKED"] = "Доступно"
  L["VT_LEVEL"] = "%d-й уровень"
  L["VT_LOCKED"] = "Н/Д"
  L["CHOOSE_CHARACTER"] = "Персонажи"
  L["GEAR_DETAIL"] = "Подробности об экипировке"
end
